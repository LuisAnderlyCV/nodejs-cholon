...
//
const vistavisuacompraid = async (req, res) => {
  // Obtén el ID 
...
const updatevisuacompraPUT = async (req, res) => {
...
module.exports = { vistavisucompra,vistavisuacompraid,updatevisuacompraPUT,deletecompra,actcompra};