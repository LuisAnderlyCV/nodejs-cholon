...
const vistaregistrocontrol = async (req, res) => {
  ...
  try {
    ...
    res.render("vistaadmin/lotes/controlregistro", {
      control: control,
      alimentos: alimentos,
...
const regismedicamento = async (req, res) => {
  try {
...
const regisalimento = async (req, res) => {
  try {
    const { cantidad, fecha, idproducto, descripcion, idgalpon, filtro } = req.body;
    const estado = 1;
...
module.exports = { vistaregistrocontrol, regisalimento, regiscontrolpollos, regismedicamento};
