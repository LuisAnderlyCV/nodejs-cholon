...
const vistacajaclientes = async (req, res) => {
  ...
  try {
    ...
    res.render("vistacajero/ventas/clientes", {
      clientes: clientes[0],
...
const regiscajaclientes = async (req, res) => {
  try {
...
const vistacajaclientesid = async (req, res) => {
  // Obtén el ID 
...
const updatecajaclientesPUT = async (req, res) => {
...
const deletecajaclientes = async (req, res) => {
...
const actcajaclientes = async (req, res) => {
...
module.exports = { vistacajaclientes, regiscajaclientes,vistacajaclientesid,updatecajaclientesPUT, deletecajaclientes, actcajaclientes };