...
const vistasuperproveedores = async (req, res) => {
...
WHERE proveedor.estado_proveedor = 0;
  ...
  try {
    ...
    res.render("vistasupervisor/compras/proveedores", {
...
const regissuperproveedors = async (req, res) => {
  try {
...
const vistasuperproveedorids = async (req, res) => {
...
const updatesuperproveedoresPUTs = async (req, res) => {
...
const deletesuperproveedoress = async (req, res) => {
...
const actsuperproveedors = async (req, res) => {
...
module.exports = {
  vistasuperproveedores,
  regissuperproveedors,
  vistasuperproveedorids,
  updatesuperproveedoresPUTs,
  deletesuperproveedoress,
  actsuperproveedors,
};
